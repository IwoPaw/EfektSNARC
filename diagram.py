...
expName = 'diagram'  # from the Builder filename that created this script
expInfo = {
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\abc\\Desktop\\Kwatera Główna\\Studia\\Statystyki\\ProgramNaEkperynemt\\diagram.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    BokTargetK = visual.ShapeStim(
        win=win, name='BokTargetK', vertices='cross',
        size=(0.014, 0.014),
        ori=0.0, pos=[0,0], anchor='center',
    ...
    TNA = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('TestNaX/TestNaA.xlsx', selection='3,4'),
        seed=None, name='TNA')
    ...
    TNK = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('TestNaX/TestNaKwadraty.xlsx', selection='1,87'),
        seed=None, name='TNK')
    ...
    for thisTNK in TNK:
        ...
        BokTestK.setPos([ztrona, 0])
        BokTestK.setSize([Bok, Bok])
        KlawiszOdpK.keys = []
        KlawiszOdpK.rt = []
        _KlawiszOdpK_allKeys = []
        BokTargetK.setPos((ztrona, 0))
        # keep track of which components have finished
    ...
    TNB = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('TestNaX/TestNaB.xlsx', selection='3,4'),
        seed=None, name='TNB')
    ...
    TNLA = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('TestNaX/TestNaLiteryA.xlsx', selection='3,4'),
        seed=None, name='TNLA')
    ...
    TNC = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('TestNaX/TestNaC.xlsx', selection='3,4'),
        seed=None, name='TNC')
    ...
    TNLB = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('TestNaX/TestNaLiteryB.xlsx', selection='3'),
        seed=None, name='TNLB')
